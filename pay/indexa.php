                ...
                $.ajax({
                    ...
                    if (data.res == 'success') {
                        ...
                        var options = {
                            ...
                            "currency": "INR",
                            "name": "Blossomcorner", //your business name
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <input type="text" name="action" value="payOrder">
                                <label>Name</label>
                            ...
                            <!-- submit button -->
                            <input type="button" id="PayNow" class="btn btn-success btn-lg btn-block" valu="Submit & Pay">
