            ...
            <table id="jquery-datatable-example-no-configuration" class="display" style="width:100vw">
                ...
                if($data['data']['data'] !==0){
                    ...
                    for($i=0;$i<count($res);$i++){
                        echo "<tr><td><a href='index.php?key=1037d9ea3af16d70f0ce197f737e4ca6a3d1f436ce0365689334069ea9772565&cid=".base64_encode($res[$i]['cid'])."&controller=admin'>".$res[$i]['cid']."</a></td><td>".$res[$i]['c_name']."</td><td>".$res[$i]['ph_num']."</td><td>".$res[$i]['email']."</td><td>".$res[$i]['city']."</td></tr>";
                    }
                }else{
