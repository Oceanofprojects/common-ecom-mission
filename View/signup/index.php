...
body {
  ...
  padding: 20px;
  background:url('../../assets/common-images/loginSignupBG.png');//linear-gradient(rgba(0,0,0,.1),rgba(0,0,0,.3));
...
@media screen and (max-width: 500px) {
  ...
  <body>
    ...
    <div style="text-align:right;">
      ...
      |
      <a style="font-size:12pt;text-decoration:none;color:#123;padding:0px 5px;" href="../../index.php?key=f01f773c6da80db08b2b3150fe2f0dcdb68ab5d8c0caa5fa9517e75b7896fdc3&controller=home" class="fa fa-sign-in"></a>
      </div>
      ...
      <form action="../../index.php" class="form" id="frm">
        ...
        <div class="column">
          ...
          <div class="input-box">
            <label>Whataspp Number<sup class="imp">*</sup></label>
            <input type="number" placeholder="Enter whataspp number" name="whatsapp_num" min="1" />
          </div>
        </div>
        ...
        <br><br>
        <p align="center">Already resgistered?, Please <a href="../../index.php?key=f01f773c6da80db08b2b3150fe2f0dcdb68ab5d8c0caa5fa9517e75b7896fdc3&controller=home">login</a></p>
