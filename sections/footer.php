...
?>
    <footer class="ft-layer">
        <div class="ft-l-info ft-sub-div"><br>
            <img src="assets/common-images/logo.png" style="border-radius:100px;" alt="Logo" height="100px"
                width="100px"><br><br>
            <h2><?php echo $info['business']['name'];?></h2><br>
            <p><?php echo $info['business']['slogan'];?></p>
            <br><br><br>
            <iframe src="<?php echo $info['business']['google_map_location'];?>" id="gMap" style="border:0;"
        ...
        <div class="ft-r-info ft-sub-div">
            <div class="ft-r-tp-box">
                <div class="ft-social-links">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo $info['social_media']['facebook'];?>"
                                class="fa fa-facebook-official"></a></li>
                        <li><a href="<?php echo 'https://wa.me/91'.$info['social_media']['whatsapp'];?>"
                                class="fa fa-whatsapp"></a></li>
                        <li><a href="<?php echo $info['social_media']['youtube'];?>" class="fa fa-youtube-play"></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="ft-r-bm-box">
                <ul>
                    ...
                    <li><a
                            href="mailto:<?php echo $info['social_media']['mail'];?>"><?php echo $info['social_media']['mail'];?></a>
                    </li>
                </ul>
                <ul>
                    <li><span>Quick links</span></li>
                    <li><a
                            href="index.php?controller=home&key=723502982ca5d2790c1f9464af3613117a3bd4e55ee0a68b6c29ab76d23b71b6">Home</a>
                    </li>
                    <li><a
                            href="index.php?key=450fa328dcada230a73f8b9797e504445116170dc6e0180da5d35b63d5b05e29&controller=product">Track
                            my order</a></li>
                ...
                <ul>
                    ...
                    <li><a
                            href="https://www.freepik.com/free-vector/leaves-pattern-background_1128617.htm#query=leaf%20icon%20background&position=1&from_view=search&track=ais&uuid=3eee07c3-42c3-4e2a-8c6d-6390d6c832c9">Image
                            by Freepik</a></li>
                </ul>
            </div>
        </div>
    ...
    <div
        style="display: flex;justify-content:center;align-items: center;flex-direction: column;text-align:center;padding:30px 0px;background:#123">
        <hr width="20%">
        <h2 style="color:#fff;font-size:13pt"><br><br>2024, All rights reserved,
            <?php echo $info['business']['name'];?><br><br><br><a
                href="https://www.instagram.com/_the_mani_maran_?utm_source=ig_web_button_share_sheet&igsh=OGQ5ZDc2ODk2ZA=="
                style="color:#fe019a">Designed by <span class="fa fa-heart"></span> </a><br><br></h2>
    </div>