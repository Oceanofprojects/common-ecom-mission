...
<div class="glide">
  ...
  <div class="glide__track" data-glide-el="track">
    <ul class="glide__slides">
      <li class="glide__slide" style="background:url('assets/slide_images/img1.jpg');background-size:cover;background-position:center;height:90vh;width:100%;"><div class='mainSlide-inner-layer'><a href="#">Shop Now&nbsp;<span class="fa fa-angle-double-right"></span></a></div></li>
      <li class="glide__slide" style="background:url('assets/slide_images/img2.jpg');background-size:cover;background-position:center;height:90vh;width:100%;"><div class='mainSlide-inner-layer'><a href="#">Shop Now&nbsp;<span class="fa fa-angle-double-right"></span></a></div></li>
      <li class="glide__slide" style="background:url('assets/slide_images/img3.png');background-size:cover;background-position:center;height:90vh;width:100%;"><div class='mainSlide-inner-layer'><a href="#">Shop Now&nbsp;<span class="fa fa-angle-double-right"></span></a></div></li>
			<li class="glide__slide" style="background:url('assets/slide_images/img4.jpg');background-size:cover;background-position:center;height:90vh;width:100%;"><div class='mainSlide-inner-layer'><a href="#">Shop Now&nbsp;<span class="fa fa-angle-double-right"></span></a></div></li>
    </ul>
  </div>
